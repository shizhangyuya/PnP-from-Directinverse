...
if __name__ == "__main__":
    ...
    parser.add_argument('--edit_category_list', nargs = '+', type=str, default=["9"]) # the editing category that needed to run
    parser.add_argument('--edit_method_list', nargs = '+', type=str, default=["instruct-pix2pix"]) # the editing methods that needed to run
    parser.add_argument('--checkpoint', type=str, default="models/instruct-pix2pix-00-22000.ckpt") # the editing methods that needed to run
